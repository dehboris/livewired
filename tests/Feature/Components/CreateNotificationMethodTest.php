...
/**
 * @covers \KodeKeep\Livewired\Components\CreateNotificationMethod
 */
class CreateNotificationMethodTest extends TestCase
{
    ...
    //         ->call('createNotificationMethod')
    //         ->assertHasErrors(['discord_url' => 'required']);
    // }
    ...
    //         ->call('createNotificationMethod')
    //         ->assertHasErrors(['mail_address' => 'required']);
    // }
    ...
    //         ->call('createNotificationMethod')
    //         ->assertHasErrors(['nexmo_api_key' => 'required']);
    // }
    ...
    //         ->call('createNotificationMethod')
    //         ->assertHasErrors(['nexmo_api_secret' => 'required']);
    // }
    ...
    //         ->set('nexmo_from', null)
    //         ->call('createNotificationMethod')
    //         ->assertHasErrors(['nexmo_from' => 'required']);
    // }
    ...
    //         ->set('nexmo_to', null)
    //         ->call('createNotificationMethod')
    //         ->assertHasErrors(['nexmo_to' => 'required']);
    // }
    ...
    //         ->call('createNotificationMethod')
    //         ->assertHasErrors(['pushover_user' => 'required']);
    // }
    ...
    //         ->call('createNotificationMethod')
    //         ->assertHasErrors(['pushover_token' => 'required']);
    // }
    ...
    //         ->set('slack_url', null)
    //         ->call('createNotificationMethod')
    //         ->assertHasErrors(['slack_url' => 'required']);
    // }
    ...
    //         ->call('createNotificationMethod')
    //         ->assertHasErrors(['webhook_url' => 'required']);
    // }
